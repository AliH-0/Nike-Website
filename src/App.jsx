const App = () => (
  <main className="relative">
    ...
    <section className="padding">PServices</section>
    <section className="padding">Special Offers</section>
    <section className="bg-pale-blue padding">Customer Reviews</section>
    <section className="padding-x sm:py-32 py-16 w-full">Subdcribe</section>
    <section className="padding bg-black padding-x padding-pb-8">
      Footer
    </section>
  </main>
);
